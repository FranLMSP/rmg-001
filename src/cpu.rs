...
impl CPU {
    ...
    pub fn run(&mut self, bus: &mut Bus) {
        ...
        let (opcode, cycles) = CPU::parse_opcode(parameter_bytes);
    ...
    pub fn parse_opcode(params: (u8, u8, u8, u8)) -> (Opcode, Cycles) {
        let opcode = params.0;
        let two_byte_param = join_bytes(params.2, params.1);
        match opcode {
            0x06 => (Opcode::LD(OpcodeParameter::Register_U8(Register::B, params.1)), Cycles(1)),
            0x0E => (Opcode::LD(OpcodeParameter::Register_U8(Register::C, params.1)), Cycles(3)),
            0x16 => (Opcode::LD(OpcodeParameter::Register_U8(Register::D, params.1)), Cycles(2)),
            0x1E => (Opcode::LD(OpcodeParameter::Register_U8(Register::E, params.1)), Cycles(2)),
            0x26 => (Opcode::LD(OpcodeParameter::Register_U8(Register::H, params.1)), Cycles(2)),
            0x2E => (Opcode::LD(OpcodeParameter::Register_U8(Register::L, params.1)), Cycles(2)),
            ...
            0x36 => (Opcode::LD(OpcodeParameter::Register_U8(Register::HL, params.1)), Cycles(3)),
            ...
            0x3E => (Opcode::LD(OpcodeParameter::Register_U8(Register::A, params.1)), Cycles(2)),
            ...
            0xE0 => (Opcode::LD(OpcodeParameter::FF00plusU8_Register(params.1, Register::A)), Cycles(3)),
            0xF0 => (Opcode::LD(OpcodeParameter::Register_FF00plusU8(Register::A, params.1)), Cycles(3)),
            ...
            0xF8 => (Opcode::LD(OpcodeParameter::Register_RegisterPlusI8(Register::HL, Register::SP, params.1 as i8)), Cycles(3)),
            ...
            0xC6 => (Opcode::ADD(OpcodeParameter::Register_U8(Register::A, params.1)), Cycles(2)),
            ...
            0xE8 => (Opcode::ADD(OpcodeParameter::Register_I8(Register::SP, params.1 as i8)), Cycles(4)),
            ...
            0xCE => (Opcode::ADC(OpcodeParameter::Register_U8(Register::A, params.1)), Cycles(2)),
            ...
            0xD6 => (Opcode::SUB(OpcodeParameter::Register_U8(Register::A, params.1)), Cycles(2)),
            ...
            0xDE => (Opcode::SBC(OpcodeParameter::Register_U8(Register::A, params.1)), Cycles(2)),
            ...
            0xE6 => (Opcode::AND(OpcodeParameter::Register_U8(Register::A, params.1)), Cycles(2)),
            ...
            0xF6 => (Opcode::OR(OpcodeParameter::Register_U8(Register::A, params.1)), Cycles(2)),
            ...
            0xEE => (Opcode::XOR(OpcodeParameter::Register_U8(Register::A, params.1)), Cycles(2)),
            ...
            0xFE => (Opcode::CP(OpcodeParameter::Register_U8(Register::A, params.1)), Cycles(2)),
            ...
            0x18 => (Opcode::JR(OpcodeParameter::I8(params.1 as i8)), Cycles(3)),
            0x20 => (Opcode::JR(OpcodeParameter::FlagRegisterReset_I8(FlagRegister::Zero, params.1 as i8)), Cycles(2)),
            0x28 => (Opcode::JR(OpcodeParameter::FlagRegisterSet_I8(FlagRegister::Zero, params.1 as i8)), Cycles(2)),
            0x30 => (Opcode::JR(OpcodeParameter::FlagRegisterReset_I8(FlagRegister::Carry, params.1 as i8)), Cycles(2)),
            0x38 => (Opcode::JR(OpcodeParameter::FlagRegisterSet_I8(FlagRegister::Carry, params.1 as i8)), Cycles(2)),
